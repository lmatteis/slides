...
{\fontsize{30}{30} {\cmr 
\noindent We can exploit a variety of {\color{blue}free} hosting services to publish our Linked Data and have clients query them. No more sys-admin tasks. Less down times.
\\\\
